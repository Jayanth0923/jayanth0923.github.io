        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div>
            ...
            >
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-primary text-white text-lg font-medium rounded-2xl hover:bg-primary-dark transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
              >
                Send Message
